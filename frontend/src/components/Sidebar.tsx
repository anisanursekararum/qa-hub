    ...
    <aside className="w-56 flex-shrink-0 flex flex-col justify-between border-r border-[#E0E0E0] dark:border-[#2D2D39] bg-[#F7F7F7] dark:bg-[#161616] h-screen sticky top-0 transition-colors duration-200">
      <div>
        ...
        <nav className="mt-4 px-3 space-y-1">
          ...
          <a href="/repo" className={`flex items-center space-x-3 px-3 py-2 rounded-[4px] font-sans text-xs font-medium transition-colors ${isLinkActive('/repo') ? 'bg-[#0F62FE] text-white shadow-sm' : 'text-[#525252] dark:text-[#A8A8A8] hover:bg-[#E8E8E8] dark:hover:bg-[#1C1C21] hover:text-[#161616] dark:hover:text-white'}`}>
            <Library size={16} />
            <span>Repo</span>
          </a>
