        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-[#E0E0E0] dark:border-[#2D2D39]">
              <th className="px-4 py-2 font-mono text-[8px] text-[#757575] dark:text-[#8D8D8D] uppercase font-semibold">Run Name</th>
              <th className="px-4 py-2 font-mono text-[8px] text-[#757575] dark:text-[#8D8D8D] uppercase font-semibold">Project</th>
              <th className="px-4 py-2 font-mono text-[8px] text-[#757575] dark:text-[#8D8D8D] uppercase font-semibold">Passed / Failed</th>
          ...
          <tbody>
            {performance.map((run) => (
              <tr key={run.id} className="border-b border-[#E0E0E0] dark:border-[#2D2D39] last:border-0 hover:bg-[#F7F7F7] dark:hover:bg-[#161616]/50 transition-colors">
                <td className="px-4 py-2.5 font-mono text-[10px] text-[#161616] dark:text-[#E0E0E0]">{run.runName}</td>
                <td className="px-4 py-2.5 font-mono text-[10px] text-[#161616] dark:text-[#E0E0E0]">{run.projectName}</td>
                <td className="px-4 py-2.5 font-mono text-[10px] text-[#161616] dark:text-[#E0E0E0]">
                ...
                <td className="px-4 py-2.5 text-right">
                  <span className={`inline-block font-mono text-[8px] font-bold uppercase px-1.5 py-0.5 rounded-[2px] border ${
                    run.status === 'DONE' ? 'border-[#24A148]/30 text-[#24A148] bg-[#24A148]/10' :
