  ...
  return (
    <div className="flex min-h-screen bg-white dark:bg-[#121212] transition-colors duration-200">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        {/* Top Header */}
        <header className="h-16 flex-shrink-0 flex items-center justify-end px-8 border-b border-[#E0E0E0] dark:border-[#2D2D39] bg-[#F7F7F7] dark:bg-[#161616] transition-colors duration-200">
