        ...
        <div className="flex justify-between h-14">
          ...
          <div className="flex items-center space-x-8">
            <a href="/" className="flex items-center space-x-2.5 focus:outline-none">
              {/* Custom QA-Hub Logo Symbol */}
              <div className="relative flex items-center justify-center w-7 h-7 bg-[#0F62FE] rounded-[4px]">
                <span className="font-mono text-xs font-black text-white leading-none tracking-tighter">QA</span>
                {/* Micro AI Aura Glow Element */}
                <div className="absolute -inset-0.5 border border-[#8A3FFC] opacity-30 rounded-[4px] blur-sm animate-pulse"></div>
              </div>
              <span className="font-sans font-bold text-base text-[#161616] dark:text-white tracking-wide">
            ...
            {user && (
              <div className="hidden md:flex space-x-1">
                <a
                  href="/projects"
                  className={`px-3 py-1.5 font-sans font-medium text-xs rounded-[4px] transition-colors duration-150 ${
